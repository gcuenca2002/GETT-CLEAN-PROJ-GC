...
# a. Clean up workspace
rm(list=ls())
#######################

# 1. Merge the training and the test sets to create one data set.
#set working directory to the location where the UCI HAR Dataset will be unzipped

setwd('C:/Users/gcuenca/Documents/GitHub/GETTING & CLEANING DATA/GETT-CLEAN-PROJ-GC/');
